...
class UpdateForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            carplate: "",
            modelid: "",
            formErrors: {VIN: '', carplate: '', modelid: ''},
            VINValid: false,
            carplateValid: false,
            modelidValid: false,
            formValid: false
    ...
    handleUpdateClick(e) {            
        ...
        if(this.state.formValid) {
            var requestLink = API_URL_CARS + this.state.id;
            ...
            if(this.state.modelid)
                jsonBody += ("\"modelid_id\": ".concat("\"", this.state.modelid, "\","));
    ...
    validateField(fieldName, value) {
        ...
        let modelidValid = this.state.modelidValid;
        ...
        switch(fieldName) {
          ...
          case 'modelid':
            modelidValid = value != "";
            fieldValidationErrors.modelid = modelidValid ? '' : ' should not be null! \u26A0';
          default:
            break;
        }
        ...
        this.setState({formErrors: fieldValidationErrors,
                        ...
                        modelidValid: modelidValid
                      }, this.validateForm);
    }
      
    validateForm() {
        this.setState({formValid: (this.state.VINValid || this.state.VIN == "") && (this.state.carplateValid || this.state.carplate == "") && this.state.modelidValid});
    }
        ...
        if(!this.state.isSubmitted) {
            return (
                ...
                <Form>
                    ...
                    <Col sm="3">
                        <FloatingLabel label="Enter Car's Model ID">
                        <Form.Control type="text" placeholder="0" name="modelid" onChange={this.handleChange} />
                        </FloatingLabel>
                    </Col>
                    ...
                    <Table responsive>
                        ...
                        <tbody>
                            <tr key="1">
                                ...
                                <td>{this.state.updatedCar.modelid_id}</td>
                            </tr>
                        </tbody>
                    </Table>
                    <br/>
